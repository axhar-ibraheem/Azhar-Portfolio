...
const Contact = () => {
  return (
    <Wrapper id="contact" classes="bg-amber-100 py-10">
      ...
      <div className="max-w-6xl w-11/12 mx-auto rounded-3xl h-3/4 py-10">
        <div className="max-w-2xl flex justify-center items-center  p-5 mx-auto lg:w-2/5 h-[26rem] bg-white shadow-lg rounded-lg">
