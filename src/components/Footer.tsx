...
const Footer = () => {
  return (
    <Wrapper
      classNames="bg-slate-700 grid place-items-center py-5 text-center"
      id="footer"
    >
      <div>
        <div className="grid grid-cols-3 w-52 mx-auto place-items-center mb-5 text-cyan-950 text-2xl">
