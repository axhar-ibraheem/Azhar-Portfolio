...
const PersonalInfo = () => {
  ...
  return (
    <Wrapper id="home" classNames={classname}>
      <div className="grid relative h-3/4 lg:ps-12 lg:pe-12 rounded-3xl lg:bg-white lg:grid-cols-2 place-content-center items-center max-w-6xl w-11/12 mx-auto py-6 lg:shadow-lg">
        <div className="text-center lg:text-start overflow-hidden">
          ...
          <div className="grid grid-cols-3 w-52 lg:hidden mx-auto place-items-center lg:place-items-start lg:mx-0 mt-5 text-cyan-950 text-2xl">
      ...
      <div className="lg:grid hidden grid-rows-3 absolute gap-8 shadow-md ps-5 py-5 w-16  text-cyan-950 bg-violet-100 text-2xl">
        <a href="https://github.com/axhar-ibraheem">
